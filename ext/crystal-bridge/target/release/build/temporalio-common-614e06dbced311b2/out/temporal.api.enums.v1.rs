...
impl ResourceExhaustedCause {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "RESOURCE_EXHAUSTED_CAUSE_PERSISTENCE_STORAGE_LIMIT" => {
                Some(Self::PersistenceStorageLimit)
            }
            "RESOURCE_EXHAUSTED_CAUSE_CIRCUIT_BREAKER_OPEN" => {
                Some(Self::CircuitBreakerOpen)
            }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "COMMAND_TYPE_CANCEL_WORKFLOW_EXECUTION" => {
                Some(Self::CancelWorkflowExecution)
            }
            "COMMAND_TYPE_REQUEST_CANCEL_EXTERNAL_WORKFLOW_EXECUTION" => {
                Some(Self::RequestCancelExternalWorkflowExecution)
            }
            "COMMAND_TYPE_RECORD_MARKER" => Some(Self::RecordMarker),
            "COMMAND_TYPE_CONTINUE_AS_NEW_WORKFLOW_EXECUTION" => {
                Some(Self::ContinueAsNewWorkflowExecution)
            }
            "COMMAND_TYPE_START_CHILD_WORKFLOW_EXECUTION" => {
                Some(Self::StartChildWorkflowExecution)
            }
            "COMMAND_TYPE_SIGNAL_EXTERNAL_WORKFLOW_EXECUTION" => {
                Some(Self::SignalExternalWorkflowExecution)
            }
            "COMMAND_TYPE_UPSERT_WORKFLOW_SEARCH_ATTRIBUTES" => {
                Some(Self::UpsertWorkflowSearchAttributes)
            }
            ...
            "COMMAND_TYPE_MODIFY_WORKFLOW_PROPERTIES" => {
                Some(Self::ModifyWorkflowProperties)
            }
            "COMMAND_TYPE_SCHEDULE_NEXUS_OPERATION" => Some(Self::ScheduleNexusOperation),
            "COMMAND_TYPE_REQUEST_CANCEL_NEXUS_OPERATION" => {
                Some(Self::RequestCancelNexusOperation)
            }
            _ => None,
        }
    }
