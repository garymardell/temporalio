...
impl ::prost::Name for DataBlob {
    const NAME: &'static str = "DataBlob";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.DataBlob".into()
    }
...
impl ::prost::Name for Payloads {
    const NAME: &'static str = "Payloads";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.Payloads".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.Payloads".into()
    }
...
impl ::prost::Name for Payload {
    ...
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.Payload".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.Payload".into()
    }
...
impl ::prost::Name for SearchAttributes {
    const NAME: &'static str = "SearchAttributes";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.SearchAttributes".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.SearchAttributes".into()
    }
...
impl ::prost::Name for Memo {
    const NAME: &'static str = "Memo";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.Memo".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.Memo".into()
    }
...
impl ::prost::Name for Header {
    ...
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.Header".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.Header".into()
    }
...
impl ::prost::Name for WorkflowExecution {
    const NAME: &'static str = "WorkflowExecution";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.WorkflowExecution".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.WorkflowExecution".into()
    }
...
impl ::prost::Name for WorkflowType {
    const NAME: &'static str = "WorkflowType";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.WorkflowType".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.WorkflowType".into()
    }
...
impl ::prost::Name for ActivityType {
    const NAME: &'static str = "ActivityType";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.ActivityType".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.ActivityType".into()
    }
...
impl ::prost::Name for RetryPolicy {
    ...
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.RetryPolicy".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.RetryPolicy".into()
    }
...
impl ::prost::Name for MeteringMetadata {
    const NAME: &'static str = "MeteringMetadata";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.MeteringMetadata".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.MeteringMetadata".into()
    }
...
impl ::prost::Name for WorkerVersionStamp {
    const NAME: &'static str = "WorkerVersionStamp";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.WorkerVersionStamp".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.WorkerVersionStamp".into()
    }
...
impl ::prost::Name for WorkerVersionCapabilities {
    const NAME: &'static str = "WorkerVersionCapabilities";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.WorkerVersionCapabilities".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.WorkerVersionCapabilities".into()
    }
...
impl ::prost::Name for ResetOptions {
    const NAME: &'static str = "ResetOptions";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.ResetOptions".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.ResetOptions".into()
    }
...
pub mod callback {
    ...
    impl ::prost::Name for Nexus {
        const NAME: &'static str = "Nexus";
        const PACKAGE: &'static str = "temporal.api.common.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "temporal.api.common.v1.Callback.Nexus".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/temporal.api.common.v1.Callback.Nexus".into()
        }
    ...
    impl ::prost::Name for Internal {
        const NAME: &'static str = "Internal";
        const PACKAGE: &'static str = "temporal.api.common.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "temporal.api.common.v1.Callback.Internal".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/temporal.api.common.v1.Callback.Internal".into()
        }
...
impl ::prost::Name for Callback {
    ...
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.Callback".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.Callback".into()
    }
...
pub mod link {
    ...
    pub mod workflow_event {
        ...
        impl ::prost::Name for EventReference {
            const NAME: &'static str = "EventReference";
            const PACKAGE: &'static str = "temporal.api.common.v1";
            fn full_name() -> ::prost::alloc::string::String {
                "temporal.api.common.v1.Link.WorkflowEvent.EventReference".into()
            }
            fn type_url() -> ::prost::alloc::string::String {
                "/temporal.api.common.v1.Link.WorkflowEvent.EventReference".into()
            }
        ...
        impl ::prost::Name for RequestIdReference {
            const NAME: &'static str = "RequestIdReference";
            const PACKAGE: &'static str = "temporal.api.common.v1";
            fn full_name() -> ::prost::alloc::string::String {
                "temporal.api.common.v1.Link.WorkflowEvent.RequestIdReference".into()
            }
            fn type_url() -> ::prost::alloc::string::String {
                "/temporal.api.common.v1.Link.WorkflowEvent.RequestIdReference".into()
            }
    ...
    impl ::prost::Name for WorkflowEvent {
        const NAME: &'static str = "WorkflowEvent";
        const PACKAGE: &'static str = "temporal.api.common.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "temporal.api.common.v1.Link.WorkflowEvent".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/temporal.api.common.v1.Link.WorkflowEvent".into()
        }
    ...
    impl ::prost::Name for BatchJob {
        const NAME: &'static str = "BatchJob";
        const PACKAGE: &'static str = "temporal.api.common.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "temporal.api.common.v1.Link.BatchJob".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/temporal.api.common.v1.Link.BatchJob".into()
        }
...
impl ::prost::Name for Link {
    ...
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.Link".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.Link".into()
    }
...
/// 1. Then, consider fairness: try to dispatch tasks for different fairness keys
...
pub struct Priority {
    ...
    /// 1. It can be attached to the workflow/activity in this field.
    /// 1. The default weight of 1.0 will be used.
    ///
    /// Weight values are clamped to the range \[0.001, 1000\].
    #[prost(float, tag = "3")]
    pub fairness_weight: f32,
}
impl ::prost::Name for Priority {
    const NAME: &'static str = "Priority";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.Priority".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.Priority".into()
    }
...
impl ::prost::Name for WorkerSelector {
    const NAME: &'static str = "WorkerSelector";
    const PACKAGE: &'static str = "temporal.api.common.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "temporal.api.common.v1.WorkerSelector".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/temporal.api.common.v1.WorkerSelector".into()
    }
